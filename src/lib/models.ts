...
export const VIDEO_MODELS: Model[] = [
  ...
  { id: "kling/v3-omni-image-to-video", name: "Kling 3.0 Omni I2V", provider: "Kuaishou", type: "i2v", tag: "pro" },
  { id: "kling/v3-omni-reference-to-video", name: "Kling 3.0 Omni Ref2V", provider: "Kuaishou", type: "ref2v", tag: "pro" },
...
export const IMAGE_MODELS: Model[] = [
  ...
  // GPT Image
  { id: "gpt-image/gpt-image-2-text-to-image", name: "GPT Image 2", provider: "OpenAI", type: "t2i", tag: "popular" },
  { id: "gpt-image/gpt-image-2-image-to-image", name: "GPT Image 2 I2I", provider: "OpenAI", type: "i2i" },
...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    category: "Film",
    models: ["kling/v3-omni-text-to-video"],
...
export const MODEL_THUMBNAILS: Record<string, { gradient: string; preview: string; icon: string }> = {
  ...
  "kling/v3-omni-image-to-video": { gradient: "from-violet-500 to-purple-600", preview: "Omni image-to-video", icon: "✨" },
  "kling/v3-omni-reference-to-video": { gradient: "from-purple-500 to-fuchsia-600", preview: "Multi-ref consistency", icon: "🎯" },
